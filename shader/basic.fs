...
// these are later inputs and not hardcoded
...
void main() {
    ...
    vec2 viewportCoord = vec2(((gl_FragCoord.x / screenWidth) - 0.5f) * 2 , ((gl_FragCoord.y / screenHeight) - 0.5f) * 2);

    float val = fractalNoise(viewportCoord);
